...
class GreedyBestFirstSearch:
    ...
    def search(grid: Grid) -> Solution:
        ...
        # Inicializar la frontera como una cola de prioridad y agregar el nodo inicial con su valor heurístico
        ...
        while not frontier.is_empty():
            # Extraer el nodo con el valor heurístico más bajo de la frontera
            node = frontier.pop()
            ...
            for i, new_state in successors.items():
                ...
                if new_state not in reached or new_cost < reached[new_state]:
                    ...
                    # Agregar el nuevo nodo a la frontera con su valor heurístico
